...
public class Boss extends FighterPlane {
	...
	public ShieldImage getShieldImage() {//used to add to the scene graph in level two class
		return shieldImage;
	}
	public void ShieldPosition(){//syncs shield position with boss
